...
For testing purposes, this project will first be developed around major cities in Thailand(Bangkok) and Malaysia(Kuala Lumpur) as a proof of concept for metro rail lines before moving on to scale its operation to inter-provincial rails of these countries and progressively, for the entire Southeast Asia.
