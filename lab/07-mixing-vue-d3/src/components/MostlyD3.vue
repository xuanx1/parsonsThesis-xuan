  ...
  computed: {
    lotteriesWithStats(){
      ...
      return this.lottery_stats.map(d => {
        ...
        const aggregates = matchingLotteries.reduce((acc, v) => { // v is the current value in the array of matchingLotteries, acc is the accumulator, which is an object with the properties numOfUnits, householdSize, and numberOfLotteries, representing the sum of the values of those properties in the array of matchingLotteries
            return {
